...
dynamic_disasters = {
    ...
    default_settings = {                            -- Default settings for the manager.
        ...
        automatic_difficulty = false,                -- If the difficulty must be chosen based on the campaign difficulty.
...
local mandatory_settings = {
    ...
    difficulty_mod = 1,               -- Difficulty multiplier used by the disaster (effects depend on the disaster).
